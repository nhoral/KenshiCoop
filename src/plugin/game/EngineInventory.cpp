...
// world-item (ground drop) diagnostics + replication proxies, the spike-451
// weapon-mint recipe trace, and the spike-401 research tech-tree store probe.
//
// Owner state: section-private statics/anon-namespace helpers only (mkspy
// trace state incl. g_mkspyBase, r401 lever cache).
