...
After your first session there is no save copying needed - the previous
session's save is already on both machines. Double-click HOST.cmd /
JOIN.cmd and answer 'y' to "Resume a previous session?", or add -Resume
